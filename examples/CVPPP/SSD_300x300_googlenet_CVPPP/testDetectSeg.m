...
detectDeployFile = '/home/fu/workspace/deeplearning/caffe-ssd/models/VGGNet/VOC0712/SSD_300x300_googlenet_CVPPP/deploy.prototxt';
detectModelFile = '/home/fu/workspace/deeplearning/caffe-ssd/models/VGGNet/VOC0712/SSD_300x300_googlenet_CVPPP/VGG_VOC0712_SSD_300x300_iter_40000.caffemodel';
detectNet = caffe.Net(detectDeployFile,detectModelFile,'test');

segDeployFile = '/home/fu/workspace/deeplearning/caffe-ssd/models/VGGNet/VOC0712/Deconv_48x48/deploy.prototxt';
segModelFile = '/home/fu/workspace/deeplearning/caffe-ssd/models/VGGNet/VOC0712/Deconv_48x48/VGG_VOC0712_SSD_48x48_iter_160000.caffemodel';
...
testList = '/home/fu/workspace/deeplearning/caffe/examples/rsd/Leaf_counts_testing.csv';
fid = fopen(testList);
tline = fgetl(fid);
while ischar(tline)
% Begin of test loop
...
for detectIter = 1:maxDetectIter
    ...
    detections(:,1:2) = detections(:,1:2)+1;
