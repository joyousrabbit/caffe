#ifndef CAFFE_CVPPPSEG_DATA_LAYER_HPP_
#define CAFFE_CVPPPSEG_DATA_LAYER_HPP_
...
class CvpppSegDataLayer : public BasePrefetchingDataLayer<Dtype> {
 public:
  explicit CvpppSegDataLayer(const LayerParameter& param);
  virtual ~CvpppSegDataLayer();
  virtual void DataLayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  // DataLayer uses DataReader instead for sharing for parallelism
  virtual inline bool ShareInParallel() const { return false; }
  virtual inline const char* type() const { return "CvpppSegData"; }
...
#endif  // CAFFE_CVPPPSEG_DATA_LAYER_HPP_
